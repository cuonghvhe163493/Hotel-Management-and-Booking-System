...
<head>
    ...
    <title>Set New Password - Hotels</title>
...
<section id="footer" class="bg_dark">
    <div class="container-xl">
        <div class="row footer_1">
            ...
            <div class="col-md-3">
                <div class="footer_1i">
                    ...
                    <p class="text-light mb-2">FPt, UniverSity,VietNam</p>
        ...
        <div class="row footer_2 text-center">
            <div class="col-md-12">
                <p class="mb-0 text-light"> Website Reserved | Design by <a class="col_yell fw-bold" href="http://www.templateonweb.com">TemplateOnWeb</a></p>
            </div>
        </div>
    </div>
</section>
