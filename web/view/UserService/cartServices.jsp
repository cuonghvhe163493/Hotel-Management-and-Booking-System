            ...
            <div class="container-xl">
                <c:if test="${empty sessionScope.cart && empty sessionScope.cartServices}">
                    <div class="text-center">
                        ...
                        <a href="${pageContext.request.contextPath}/services" class="btn btn-primary mt-3">Browse Service</a>
                    </div>
                </c:if>
                            ...
                            <tbody>
                                <c:forEach var="item" items="${sessionScope.cart}">
                                    <tr>
                                        ...
                                        <td>
                                            <form action="${pageContext.request.contextPath}/services" method="post" style="display:inline;">
