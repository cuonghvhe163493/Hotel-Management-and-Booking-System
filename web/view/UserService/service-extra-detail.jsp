        ...
        <section id="center" class="center_o pt-4 pb-5 text-center bg-dark text-white">
            <div class="container-xl">
                ...
                <h6 class="mb-0 mt-3 text-warning">
                    ...
                    <span class="mx-2 text-muted">/</span> Extra Service Detail
                </h6>
            </div>
        </section>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-7">
                            ...
                            <ul class="list-unstyled mb-3">
                                ...
                                <li><i class="fa fa-money me-2 col_yell"></i> ${service.servicePrice} $/night</li>
                                <li><i class="fa fa-info-circle me-2 col_yell"></i> Description ${service.serviceDescription}</li>
                            </ul>
