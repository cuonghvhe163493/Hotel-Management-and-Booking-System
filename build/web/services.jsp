    ...
    <body>
                    ...
                    <div class="container-xl">
                        <div class="row center_o1 text-center">
                            <div class="col-md-12">
                                ...
                                <h6 class="mb-0 mt-3 col_yell"><a class="text-white" href="#">Home</a> <span class="mx-2 text-muted">/</span> Services</h6>
                            </div>
                        </div>
                    </div>   
                </section>
        ...
        <section id="serv_pg" class="p_3 bg-light">
            <div class="container-xl">
                ...
                <div>
                    <form action="services" method="get" class="filter-form">
                        ...
                        <button type="button" onclick="resetInputs()">Làm mới</button>
                    </form>
                </div>
                ...
                <script>
                    function resetInputs() {
                        ...
                        form.submit();// chọn lại option đầu tiên (All Types)
                    }
                </script>
            ...
            <<section>
                ...
                <div class="pagination">
                    ...
                    <c:url var="prevUrl" value="services">
                    ...
                    <c:url var="nextUrl" value="services">
                        <c:param name="page" value="${page + 1}" />
                        <c:param name="pageSize" value="${pageSize}" />
                        <c:param name="name" value="${param.name}" />
                        <c:param name="minPrice" value="${param.minPrice}" />
