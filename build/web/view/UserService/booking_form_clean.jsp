        ...
        <div class="container mt-5 mb-5">
            <div class="card shadow-lg border-0">
                <div class="card-body p-5">
                    ...
                    <!-- Empty cart check -->
                    <c:if test="${empty sessionScope.cartExtraServices}">
                        <div class="alert alert-warning text-center">
                            <h5>Your cart is empty!</h5>
                            <p>Please add extra services to proceed with booking.</p>
                            <a href="${pageContext.request.contextPath}/extra-services" class="btn btn-primary mt-2">
                                Browse Extra Services
                            </a>
                        </div>
                    </c:if>
                    ...
                    <c:if test="${not empty sessionScope.cartExtraServices}">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="item" items="${sessionScope.cartExtraServices}">
                                        <tr>
                                            ...
                                            <td>
                                                <fmt:formatNumber value="${item.service.servicePrice}" type="number" maxFractionDigits="0"/>
                                            </td>
                                            <td>
                                                <fmt:formatNumber value="${item.service.servicePrice * item.guestsCount}" type="number" maxFractionDigits="0"/>
                                            </td>
                                        </tr>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="${pageContext.request.contextPath}/extra-service-cart" class="btn btn-secondary btn-lg">
                                <i class="fa fa-arrow-left"></i> Back to Cart
                            </a>
                            <a href="${pageContext.request.contextPath}/service-confirm-booking-v2" class="btn btn-success btn-lg">
