...
public class VoucherDAO {
    ...
    public List<Voucher> getAllVouchers() {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            e.printStackTrace();
            // Nếu lỗi, trả về danh sách rỗng, không phải null
        }
        return vouchers; 
    }
    ...
    public boolean createVoucher(String code, double discountValue, String description) {
        ...
        String sql = "INSERT INTO dbo.Vouchers (code, description, discount_type, discount_value, start_date, end_date, usage_limit, created_at, updated_at) "
                   + "VALUES (?, ?, ?, ?, GETDATE(), DATEADD(year, 1, GETDATE()), 100, GETDATE(), GETDATE())";
    ...
    public boolean updateVoucher(int voucherId, String code, double discountValue, String description) {
        ...
        String sql = "UPDATE dbo.Vouchers SET code=?, description=?, discount_type=?, discount_value=?, updated_at=GETDATE() WHERE voucher_id=?";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            ps.setString(3, discountType);
            ps.setDouble(4, discountValue);
            ps.setInt(5, voucherId); // Tham số thứ 5
    ...
    public boolean deleteVoucher(int voucherId) {  return false; }
}