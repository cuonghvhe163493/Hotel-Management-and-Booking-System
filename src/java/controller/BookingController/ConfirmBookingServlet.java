    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            for (int i = 0; i < roomCount; i++) {
                ...
                subtotal += room.getPricePerNight() * nights; // đã là double, bỏ .doubleValue()
            ...
            for (Map<String, Object> item : cartFromForm) {
                ...
                bookingDAO.addRoomToBooking(
                        ...
                        sdf.format(checkOut),
                        guests,
                        room.getPricePerNight(), // đã là double
                        "reserved" // hợp lệ với Booking_Rooms
                );

                // roomDAO.updateRoomStatus(room.getRoomId(), "occupied"); // nếu muốn tự động set phòng
            }
